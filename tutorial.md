...
In this tutorial, we will use only a subset of the RDP 2016 reference package. TIPP has already been run on the first 2,500 sequences from the 16S sample (SRR1219742). As the majority of classified reads (929 reads) were identified as Clostridia, the RDP Bacteria reference package has been constrained to the 707 sequences in the Clostridia class. This reads can now be classified at the family, genus, and species levels using TIPP!
