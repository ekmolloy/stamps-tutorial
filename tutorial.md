...
The size of the reference package has been reduced as followed to reduce the time to do this tutorial. First, TIPP was run on the first 2,500 sequences from the 16S sample (SRR1219742). This showed that the majority of classified reads (929 reads) were identified as Clostridia, and hence, the RDP Bacteria reference package was constrained to 707 sequences in the Clostridia class. This tutorial will focus on classifying these reads at the family, genus, and species levels using TIPP!

The final part of this tutorial use TIPP for abundance profiling on a set of marker genes from 
